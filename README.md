...
- Если нужно установить в подпапку (например `/jmaka/` на существующем домене) — выберите соответствующий `path prefix` в мастере.

## Assets
- `jmaka-0.1.0b-linux-x64.tar.gz` — linux-x64 архив приложения (framework-dependent).
